 ...
 */
final class Version20220314210632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE part ADD steady_price DOUBLE PRECISION DEFAULT NULL');
    }
