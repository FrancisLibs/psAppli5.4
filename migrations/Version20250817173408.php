 ...
 */
final class Version20250817173408 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` ADD created_by_id INT NOT NULL, ADD status VARCHAR(10) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE `order` DROP created_by_id, DROP status');
    }
}
