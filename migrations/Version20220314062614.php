 ...
 */
final class Version20220314062614 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE workorder ADD price DOUBLE PRECISION DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE workorder DROP price, CHANGE remark remark LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE request request VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE implementation implementation VARCHAR(255) DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
